# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 14:06:02 2020
...
class Data:
    ...
    MEETING_TIMES = [["MT1", "MWF 09:00 - 10:00"],
                     ...
                     ["MT3", "TTH 09:00 - 10:30"],
                     ["MT4", "TTH 10:30 - 12:00"]]
    INSTRUCTORS = [["I1", "Dr Berin Greeni"],
                   ["I2", "Mrs. Lavanya"],
                   ["I3", "Dr Radhika S"],
                   ["I4", "Dr. Nisha V M"]]
    def __init__(self):
...
class GeneticAlgorithm:
    def evolve(self, population): return self._mutate_populatioin(self._crossover_population(population))
    ...
    def _mutate_populatioin(self, population):
...
class DisplayMgr:
    ...
    def print_schedule_as_table(self,schedule):
        ...
        #for i in range(0,len(classes)):
            #table.add_row([str(i),classes[i].get_dept().get_name(),classes[i].get_course().get_name()+"("+ classes[i].get_course().get_number()+","+str(classes[i].get_course.get_maxNumbOfStudents())+")",classes[i].get_room().get_number()+"("+str(classes[i].get_room().get_seatingCapacity())+")",classes[i].get_instructor().get_name(),classes[i].get_meetingTime().get_time()])
        print(table)
        
    def print_generation(self,population):
        table1 = prettytable.PrettyTable(['schedule #','fitness','# of confilcts','çlasses[dept,class,room,instructor]'])
